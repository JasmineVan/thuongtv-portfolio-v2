...
const projects = [
    {
        ...
        description: "The Dogs Park project is a community-oriented space designed for dogs and their owners to socialize and play. It features designated areas for small and large dogs, agility equipment for exercise. The park hosts regular events, including training workshops and social meetups, fostering a vibrant community of dog lovers.",
    },
    {
...
const ProjectComponent = ({ icon, name, role, tech, description }: typeof projects[0] & { icon: ReactNode }) => (
    <div className="group flex flex-col gap-2 w-auto h-auto py-2 border-2 border-slate-200 rounded-xl 
transition-all duration-300 hover:shadow-lg hover:shadow-secondary/50 hover:border-secondary hover:-translate-y-2 bg-white">
    ...
    transition-all duration-300">
        ...
        <h1 className="text-xl font-light text-secondary px-4">
            {role}
        </h1>
        {/* Technical stacks */}
    ...
    return (
        <div className="flex justify-center py-32 bg-[#f8f8f8]">
            ...
            <div className="w-10/12 h-auto flex flex-col items-center justify-between gap-4">
                ...
                <h1 className="text-4xl font-semibold text-primary font-tertiary">Spotlight projects</h1>
                {/* Project cards */}
